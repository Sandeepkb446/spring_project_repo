...
public class ProductServiceImpl implements IProductService {
	...
	@Override
	@Cacheable(value="getproductbyname" , key="#name")
	...
	@Override
	@Cacheable(value="getAllProduct",key = "'ALL'")
	...
	@Caching(evict = {
			@CacheEvict(value="getproductbyname" , key="#name"),
			 @CacheEvict(value="getAllProduct",allEntries = true)
	})
	...
	public String updateProductByName(String name , ProductRequest request) {
		Optional<ProductEntity> opt = 	iProductRepository.findByPname(name);
		...
		entity.setPrice(request.getPrice());
		entity = iProductRepository.save(entity);
		return "Product Updated Succcesfully";
	}
